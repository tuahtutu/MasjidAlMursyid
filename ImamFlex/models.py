...
def validate_pdf_file(value):
    ...
    if ext != '.pdf':
        raise ValidationError('Sila muat naik fail PDF sahaja.')
    ...
    try:
        ...
        if file_header != b'%PDF':
            raise ValidationError('Fail yang dimuat naik bukan PDF yang sah.')

    except Exception:
        raise ValidationError('Fail PDF tidak dapat disahkan.')
...
class Khutbah(models.Model):
    ...
    # Keep this field for old khutbah records.
    # New khutbah records will use PDF instead.
